...
width,height = hp.getWidthHeight()
...
fall_velocity = 0.4 #higher difficulty : 0.4
jump_vertical_ratio = 0.01
hand_pos = [260, 260, 360, 360]  # hand position
...
ground = Image('./flappy_bird_image/base.png', [400, 8])
#background = Image('./flappy_bird_image/background-day.png', [width-200,height-200])
...
frame = simplegui.create_frame("Flappy bird game with hand control", width , height ,200)
