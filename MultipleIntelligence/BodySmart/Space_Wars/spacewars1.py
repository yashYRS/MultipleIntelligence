...
def exitfunc():
    print(game.score)
    nscore=round(gscore/600,2)
    print(nscore)
    turtle.bye()
    
timer=Timer(80, exitfunc)
timer.start()
...
while True:
    ...
    for enemy in enemies:
        ...
        if game.level > 2:
            if random.randint(1, 750/game.level) == 1:
