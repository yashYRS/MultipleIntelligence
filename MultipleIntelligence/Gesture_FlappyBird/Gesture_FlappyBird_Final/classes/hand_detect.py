...
def detect_hand(img, hand_pos):
    ...
    if platform == "linux" or platform == "linux2" and open_window_flag:
        ...
        cv2.putText(img,'Place your hand in the green box to start the game', (10,50), cv2.FONT_HERSHEY_SIMPLEX, 0.7,(0,0,255),2) 
        cv2.putText(img,'And make the bird fly between the pipes', (10,80), cv2.FONT_HERSHEY_SIMPLEX, 0.7,(0,0,255),2)  
